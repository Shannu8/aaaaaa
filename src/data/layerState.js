...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'local-icebergs', token: 'j', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-icebergs-full', token: 'k', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-sea-ice', token: 'z', disposition: 'enabled-only' }),
